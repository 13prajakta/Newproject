                      ...
                      <div class="col-md-12">
                        ...
                        <div class="row">
                          <div class="col-md-9 col-xs-11 img">
                            <form class="form-inline imgform" action="getimage.php" method="post" enctype="multipart/form-data">
                              <div class="form-group">
                                <label for="exampleInputName2">Select Images</label>
                                <input type="file" class="form-control" name="image" id="exampleInputName2" required >
                              </div>
                              <h4>~jpg,png*</h4>
                           
                              <button type="submit" class="btn btn-default">SUBMIT</button>
                              <a href="image1.html" style="color: #fff;text-decoration: none;"><button type="submit" value="submit" class="btn btn-default">RESET</button></a>
                            </form>
                          </div>
                        </div>
                      </div>
              ...
              <div class="row">
                <div class="col-md-12 col-xs-12 footer">
                   ...
                   <div class="col-md-4 col-xs-12 text-center">
                      <a href="https://www.facebook.com/" data-toggle="tooltip" data-placement="left" title="Facebook"><img src="img/face.png"></a>
                      <a href="https://twitter.com/" data-toggle="tooltip" data-placement="top" title="Twitter"><img src="img/twit.png"></a>
                      <a href="https://www.instagram.com/" data-toggle="tooltip" data-placement="top" title="instagram"><img src="img/insta.png"></a>
                      <a href="https://www.google.com/gmail" data-toggle="tooltip" data-placement="top" title="google"><img src="img/g+.png"></a>
                      <a href="https://in.linkedin.com/" data-toggle="tooltip" data-placement="right" title="linkedin"><img src="img/link.png"></a>
