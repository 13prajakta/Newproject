          ...
          <div class="col-md-12 col-xs-12">
            ...
            <!-- sidebar -->
              <div class="row" >
                  ...
                  <!-- mainsection -->
                  <div class="col-md-9 col-xs-12 main imgmain" style="background-color: #fff;">
                    <div class="row">
                      <div class="col-md-12">
                        <h1>PREVIEW</h1>
                        <h3 style="font-style: i">Oh!! You are looking fabulous...You are all set to go!!</h3>
                        <div class="row img1">
                          <div class="col-md-4 col-xs-4 hovimg">
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true" class="cross"><img src="img/cancel.png" class="img-responsive" width="20" height="20"></span>
                              </button>
                               <a href=""class="thumbnail"><img src="img/vickyr.jpg" class="image"></a>
                          </div>
                          <div class="col-md-4 col-xs-4 hovimg">
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true"class="cross"><img src="img/cancel.png" class="img-responsive" width="20" height="20"></span>
                                  </button>
                                  <a href=""class="thumbnail"><img src="img/tortr.jpg" class="image" ></a>
                          </div>
                          <div class="col-md-4 col-xs-4 hovimg">
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true"class="cross"><img src="img/cancel.png" class="img-responsive" width="20" height="20"></span>
                                  </button>
                                  <a href=""class="thumbnail"><img src="img/camr.jpg" class="image"></a>
                          </div>
                          <div class="col-md-4 col-xs-4 hovimg">
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true" class="cross"><img src="img/cancel.png" class="img-responsive" width="20" height="20"></span>
                                  </button> 
                                  <a href=""class="thumbnail"><img src="img/tomr.jpg" class="image"></a>
                          </div>
                          <div class="col-md-4 col-xs-4 hovimg">
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true"class="cross"><img src="img/cancel.png" class="img-responsive" width="20" height="20"></span>
                                  </button>
                                  <a href=""class="thumbnail"><img src="img/seenr.jpg" class="image"></a>
                          </div>
                          <div class="col-md-4 col-xs-4 hovimg">
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true"class="cross"><img src="img/cancel.png" class="img-responsive" width="20" height="20"></span>
                                  </button>
                                  <a href=""class="thumbnail"><img src="img/jocker.jpg" class="image"></a>
                          </div>
                          <div class="col-md-4 col-xs-4 hovimg">
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true"class="cross"><img src="img/cancel.png" class="img-responsive" width="20" height="20"></span>
