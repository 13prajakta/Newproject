...
<html lang="en">
  <head>
    ...
    <title>Admin Feedback Pannel</title>
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-bordered">
                            <tr class="headfeed">
                              ...
                              <th class="text-center">PLACE <span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span></th>
                              <th class="text-center">COMMENTS <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span></th>
                              <!-- <th class="text-center">RATINGS <span class="glyphicon glyphicon-star" aria-hidden="true"></span></th> -->
                              <th class="text-center">ACTION</th>
                            </tr>
                            <?php 
                              while ($data = $result->fetch_object()) {
                                echo"<tr>";
                                echo "<td>$data->f_id</td>";
                                echo "<td>$data->fname</td>";
                                echo "<td>$data->fcontact</td>";
                                echo "<td>$data->femail</td>";
                                echo "<td>$data->faddress</td>";
                                echo "<td>$data->fcomment</td>";
                                echo "<td>";
                                  echo "<a href='delete.php?fid=$data->f_id'>DELETE</a>";
                                echo "</td>";
                                echo "</tr>";
                              }
                               ?>
